...
declare module 'node-ssh' {
	...
	class NodeSsh {
		...
		public async getFile(localFile: string, remoteFile: string, givenSftp?: object = null, givenOpts?: object = null): Promise<void>;

		public async putFile(localFile: string, remoteFile: string, givenSftp?: object = null, givenOpts?: object = null): Promise<void>;
